...
struct ListDirection
{
    ...
    {
        if (this->south == dir) this->south = Direction::Uninitialized;
        if (this->east == dir) this->east = Direction::Uninitialized;
        if (this->west == dir) this->west = Direction::Uninitialized;
        if (this->north == dir) this->north = Direction::Uninitialized;
    }
    ...
    Direction getNext(Direction dir)
    {
        ...
        case Direction::South:
            ...
            else if (this->west == Direction::West)
                retDir = Direction::West;
            else if (this->north == Direction::North)
    ...
    Direction begin()
    {
        if (this->south == Direction::South) return Direction::South;
        if (this->east == Direction::East)  return Direction::East;
        if (this->west == Direction::West)  return Direction::West;
        if (this->north == Direction::North) return Direction::North;
    ...
    Direction front() { return begin(); }
    Direction frontRev() { return beginRev(); }
